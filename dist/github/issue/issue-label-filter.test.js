...
// src/github/issue/issue-label-filter.test.ts
describe("filterIssuesByLabels", () => {
  ...
  it("should return all issues when no target labels specified", () => {
    ...
    globalExpect(result).toEqual(issues);
    globalExpect(consoleSpy).toHaveBeenCalledWith(
  ...
  it("should handle empty issues array", () => {
    ...
    globalExpect(result).toEqual([]);
    globalExpect(consoleSpy).toHaveBeenCalledWith("No issues to filter.");
  });
});
...
@vitest/snapshot/dist/index.js:
   ...
   *)
*/
//# sourceMappingURL=issue-label-filter.test.js.map
